...
#CE QU'IL FAUT FAIRE
#changer le systeme de 'execute_one_time' --> c'est vraiment mal fait!
#faire un meilleur système de collision/ et les mettre pour les deux catapultes
#faire que la collision ce fasse qu'une seule fois sol possible mais pas top top -> mettre une var dans les conditions du check collide, puis la mettre a false, et la remettre a True lors du changement de tour (cf: ~340 ligns)
#faire que le camera return mette toujours la cata au milieu
...
class Catapulte:
	...
	def check_collision(self):
		...
		if world.execute_one_time == True and world.tour == 0 and catapulte2.posx - 20 < catapulte1.posx_proj < catapulte2.posx + catapulte2.largeur_img + 20 and catapulte2.posy - 20 < catapulte1.posy_proj < catapulte2.posy + catapulte2.hauteur_img + 20:
		...
		if world.execute_one_time == True and world.tour == 1 and catapulte1.posx - 20 < catapulte2.posx_proj < catapulte1.posx + catapulte1.largeur_img + 20 and catapulte1.posy - 20 < catapulte2.posy_proj < catapulte1.posy + catapulte1.hauteur_img + 20:
...
catapulte1 = Catapulte(368, 420, catapulte_left_img, 375, 439, 377, 441,   402, 439, 404, 441,     371, 420, red_bird_img, part_cata_left_img, 368, 420, 'red', list_img_life, 358, 390)
