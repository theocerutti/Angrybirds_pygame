...
class Catapulte:
	...
	def __init__(self, posx, posy, image, x0ela, y0ela, x1ela, y1ela, x2ela, y2ela, x3ela, y3ela, posx_projectile, posy_projectile, image_projectile, inverseur):
		...
		self.vy = 0
		self.vx = 10
		self.inverseur = inverseur #celui ci va être utiliser pour inverser la vitesse du projectile de droite
	...
	def drag_obj(self, event):
		...
		if self.drag == True:
			...
			canvas.coords(self.image_proj, souris_x - 45, souris_y - 45)
	...
	def shoot(self):
		...
		self.vy = min(20, self.vy) #permet de limiter vy à 20, pour pas que le projectile tombe de + en + vite à l'infini
		self.posx_proj += self.vx * self.inverseur
...
catapulte1 = Catapulte(80, 290, catapulte_left, 96, 327, 100, 331,   137, 327, 141, 331, 70, 285, red_bird_img, 1)
catapulte2 = Catapulte(680, 290, catapulte_right, 722, 327, 726, 331,   764, 327, 768, 331, 690, 285, red_bird_img, -1)
