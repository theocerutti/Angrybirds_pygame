...
class World:
	...
	def calcul_spe_obj_shift_y(self, shift_y, obj, obj_posx0, obj_posy0, obj_posx1, obj_posy1):
		"""Fonction permettant le calcul du shift en y, c'est à dire des objets graphiques : lignes, carrées...."""
	...
	def shift_world(self, obj_posx, obj_posy):
		"""Permet le shift du monde, pour l'instant cela n'est affecté QUE par le proj de gauche"""
...
catapulte1 = Catapulte(80, 290, catapulte_left_img, 96, 327, 100, 331,   137, 327, 141, 331,      80, 300, red_bird_img)
catapulte2 = Catapulte(696, 290, catapulte_right_img, 698, 327, 702, 331,   739, 327, 743, 331,      693, 300, red_bird_img)
