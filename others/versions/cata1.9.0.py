...
class Catapulte:
	...
	def return_camera(self):
		...
		#et on fait le shift
		background.posx += diff_longueur

		#obj proj1
		catapulte1.posx += diff_longueur
		catapulte1.x0ela += diff_longueur
		catapulte1.x1ela += diff_longueur
		catapulte1.x2ela += diff_longueur
		catapulte1.x3ela += diff_longueur
		catapulte1.x_center_ela += diff_longueur
		catapulte1.posx_proj_initale += diff_longueur
		catapulte1.posx_proj += diff_longueur
		for point in range(len(catapulte1.list_point_trajectoire)):
			catapulte1.list_point_trajectoire_x[point] += diff_longueur


		#obj proj2
		catapulte2.posx += diff_longueur
		catapulte2.x0ela += diff_longueur
		catapulte2.x1ela += diff_longueur
		catapulte2.x2ela += diff_longueur
		catapulte2.x3ela += diff_longueur
		catapulte2.x_center_ela += diff_longueur
		catapulte2.posx_proj_initale += diff_longueur
		catapulte2.posx_proj += diff_longueur
		for point in range(len(catapulte2.list_point_trajectoire)):
			catapulte2.list_point_trajectoire_x[point] += diff_longueur
