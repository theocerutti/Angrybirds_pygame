...
#CE QU'IL FAUT FAIRE
#lorsque que le J1 tire et le proj tombe sur le sol, alors la caméra va aller se placer sur le J2 (le J2 sera au milieu de l'écran), lorsque que le J2 tirera et que son proj tombera sur le sol, la cam ira ira sur le J1 et ainsi de suite..
...
#pourquoi ne pas directement faire (pour le shift) --> self.posx -= 350 (par ex) au lieu d'utiliser la fonction ce serait large plus simple et plus comprehensible
