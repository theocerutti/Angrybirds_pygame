...
#plusieurs bug de shift bizarres : j'avais oublbié de reinitialiser self.pox_shift dans le fonc de reset !
...
#----------------------------------------------------------------------------------------------------
# FONTS"/lib/font/angrybirds-regular.ttf"

tour_font = ImageFont.truetype("lib/font/angrybirds-regular.ttf", 28)
